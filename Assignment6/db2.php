...
<nav class= "navbar">
  <ul>
    ...
    <li><a href="db1.php">CSC235 Database</a></li>
...
<?php
    ...
    $sql = "SELECT * FROM carneiror1Research ORDER BY dateAccessed";
      ...
      <div class="overlay">
        <div class="text">CSC 235 Spring 2023
          ...
          if ($result->num_rows > 0) {
             ...
             echo "<center><table id='database-results'><th>Date</th><th>URL</th><th>Title</th><th>Comments</th>";
             // output data of each row returned from the database query in an HTML table cell
             while($row = $result->fetch_assoc()) {
              echo "<tr><td>" . $row["dateAccessed"] . "</td><td>" . $row["url"] . "</td><td>" .$row["title"]."</td><td>". $row["comments"]. "</td></tr>";
            }
          } else {
